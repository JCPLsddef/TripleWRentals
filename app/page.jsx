        ...
        <div className="desktop-nav-items" style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
          {[['Fleet', '#fleet'], ['How It Works', '#how'], ['Reviews', '#reviews'], ['FAQ', '#faq']].map(([label, href]) => (
            <a key={label} href={href} style={{
              ...
              onMouseEnter={e => e.target.style.color = '#C9963A'}
              onMouseLeave={e => e.target.style.color = 'rgba(242,237,227,0.65)'}
            >{label}</a>
          ))}
          <a href="tel:9729656901" style={{
            ...
            onMouseEnter={e => e.target.style.background = '#E0B254'}
            onMouseLeave={e => e.target.style.background = '#C9963A'}
          >(972) 965-6901</a>
        </div>
      ...
      <section id="reviews" style={{ background: '#F2EDE3', padding: '96px 0', overflow: 'hidden' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', marginBottom: 48 }}>
          <div className="reveal" style={{ marginBottom: 8 }}>
            ...
            <p style={{
              fontSize: 14, color: '#5A6B62',
              fontFamily: "'DM Sans', sans-serif",
            }}>★★★★★ Rated on Google · Tyler, Texas</p>
          </div>
        </div>
            ...
            {doubled.map((r, i) => (
              <div key={i} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div>
                    <div style={{
                      fontSize: 13, fontWeight: 600, color: '#0B2012',
                      fontFamily: "'DM Sans', sans-serif",
                    }}>{r.name}</div>
                    <div style={{
                      fontSize: 12, color: '#5A6B62',
          ...
          <div className="why-grid" style={{
            ...
            {[
              ...
              >
                ...
                <p style={{
                  fontSize: 15, color: '#5A6B62', lineHeight: 1.75,
                  fontFamily: "'DM Sans', sans-serif",
                }}>{card.body}</p>
              </div>
            ))}
      ...
      <section style={{ background: '#0B2012', padding: '80px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <p style={{
              fontFamily: "'DM Sans', sans-serif",
              fontSize: 16, color: 'rgba(242,237,227,0.5)',
            }}>14078 State HWY 110 N, Tyler, Texas 75704</p>
          </div>
      ...
      <footer style={{
        ...
        <div className="footer-grid" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {[['Our Fleet', '#fleet'], ['How It Works', '#how'], ['Reviews', '#reviews'], ['FAQ', '#faq'], ['Book Now', '#quote']].map(([label, href]) => (
                <a key={label} href={href} style={{
                  ...
                  onMouseEnter={e => e.target.style.color = '#C9963A'}
                  onMouseLeave={e => e.target.style.color = 'rgba(242,237,227,0.45)'}
                >{label}</a>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <p style={{
              fontSize: 13, color: 'rgba(242,237,227,0.25)',
              fontFamily: "'DM Sans', sans-serif",
            }}>Owner: Westin Wayne Walker</p>
          </div>
