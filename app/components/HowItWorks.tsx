  ...
  const steps = [
    {
      ...
      description: "Share your dates, destination, and group size. We'll match you to the right RV and confirm availability — usually within a day.",
    },
    {
      icon: Calendar,
      ...
      */}
      <div className="relative w-full
        ...
        >
          ...
          >
            Most bookings confirmed within a day &nbsp;·&nbsp; White-glove service from first call to last night
          </p>
        </motion.div>
